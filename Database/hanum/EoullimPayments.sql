...
CREATE TABLE IF NOT EXISTS `EoullimPayments` (
  ...
  `refundAmount` bigint(20) unsigned DEFAULT NULL COMMENT '결제취소금액',
  ...
  `refundTime` datetime DEFAULT NULL COMMENT '결제취소시간',
  PRIMARY KEY (`id`),
  ...
  CONSTRAINT `EOULLIM_PAYMENTS_BOOTH_BALANCE_ID_FK` FOREIGN KEY (`boothBalanceId`) REFERENCES `EoullimBalances` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `EOULLIM_PAYMENTS_BOOTH_ID_FK` FOREIGN KEY (`boothId`) REFERENCES `EoullimBooths` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `EOULLIM_PAYMENTS_USER_BALANCE_ID_FK` FOREIGN KEY (`userBalanceId`) REFERENCES `EoullimBalances` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `EOULLIM_PAYMENTS_USER_ID_FK` FOREIGN KEY (`userId`) REFERENCES `users` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
