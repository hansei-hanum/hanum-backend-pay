...
public class StoredProcedureResult {
    public static readonly Dictionary<string, HanumStatusCode> ErrorCodes = new() {
...
public class StoredProcedureResult<TValue> {
    ...
    public string? ErrorMessage => ErrorCode != null ? StoredProcedureResult.ErrorMessages.GetValueOrDefault(ErrorCode, $"({ErrorCode}) 정의되지 않은 오류입니다.") : null;
